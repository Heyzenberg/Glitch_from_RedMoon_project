...
const elementsBG = () => {
	const ParticleEngine = (function() {
		...
		function ParticleEngine(canvas_id) {
			...
			this.particleSettings = [{id:"small", num:300, fromX:0, toX:this.totalWidth, ballwidth:3, alphamax:0.4, areaHeight:.5, color:"#7bdd9b", fill:false}, // Кольца
									{id:"medium", num:100, fromX:0, toX:this.totalWidth,  ballwidth:8, alphamax:0.3, areaHeight:1, color:"#d4d479", fill:true}, // Шары
									{id:"large", num:10, fromX:0, toX:this.totalWidth, ballwidth:30,  alphamax:0.2, areaHeight:1, color:"#bdf5ff", fill:true}]; // Блики
			this.particleArray = [];
			this.lights = [{ellipseWidth:400, ellipseHeight:100, alpha:0.4, offsetX:0, offsetY:0, color:"#80865b"}, // Центральная линия света
							{ellipseWidth:350, ellipseHeight:250, alpha:0.3, offsetX:-50, offsetY:0, color:"#54d5e8"}, // Общее свечение
							{ellipseWidth:100, ellipseHeight:80, alpha:0, offsetX:80, offsetY:-50, color:"#80865b"}]; // Плавающий блик
	...
	function weightedRange(to, from, decimalPlaces, weightedRange, weightStrength){
		...
		else if(weightedRange && Math.random()<=weightStrength){
